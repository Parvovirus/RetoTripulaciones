...
const ActivityReserved = () => {
  ...
  return (
    <div className="Activity1">
      ...
      <div className="container-subscription-button  ">  {sessionact!=undefined? <button onClick={()=>setShowMessage(true)} className="login">
            Cancelar Subscripción
          </button> : "" }</div>

{showMessage?<div className="message-info">
¿Estás seguro de que quieres cancelar?
Tu reserva se cancelará y tu plaza quedará disponible para otra persona

<div className="container-buttons-message">
<button onClick={()=>savePlan()} className="buttons-sessions">Si</button>
